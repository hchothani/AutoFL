...
def get_model_class(model_name: str):
    ...
    # --- MobileNet Wrappers ---
        ...
        def build_mobilenet_v2(num_classes=10, in_channels=3):
            return MobileNet(
                num_classes=num_classes, in_channels=in_channels, version="v2"
            )
        ...
        def build_mobilenet_v3_small(num_classes=10, in_channels=3):
            return MobileNet(
                num_classes=num_classes, in_channels=in_channels, version="v3_small"
            )
        ...
        def build_mobilenet_v3_large(num_classes=10, in_channels=3):
            return MobileNet(
                num_classes=num_classes, in_channels=in_channels, version="v3_large"
            )
        ...
        raise ValueError(
            f"Model '{model_name}' not found. Supported options: {supported}"
        )
