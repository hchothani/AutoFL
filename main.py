...
def main():
    ...
    if wandb_enabled:
        ...
        # Plot FL metrics against elapsed runtime, not training step.
        wandb.define_metric("async/elapsed_time")
        wandb.define_metric("async/global_test_accuracy", step_metric="async/elapsed_time")
        wandb.define_metric("async/global_test_loss", step_metric="async/elapsed_time")
        wandb.define_metric("sync/elapsed_time")
        wandb.define_metric("sync/accuracy", step_metric="sync/elapsed_time")
        wandb.define_metric("sync/loss", step_metric="sync/elapsed_time")
